 ...
 * Utf-8 utils
 *-----------------------------------------------------------------*/
static size_t utf8_surrogate_len(const char* character)
{
    size_t result = 0;
    char test_char;
    if (!character)
...
static size_t utf8_strlen(const char* string)
{
...
static uint32_t utf8_to_utf32(const char* character)
{
    uint32_t result = -1;
...
static int texture_font_load_face(texture_font_t* self, float size, FT_Library* library, FT_Face* face)
{
    FT_Error error;
    FT_Matrix matrix = {
...
static void texture_font_generate_kerning(texture_font_t* self, FT_Library* library, FT_Face* face)
{
    (void) library;
    size_t i, j;
