...
#define VECTOR_INSERT(_x, _i, _s, _e) __extension__({                         \
    ...
    _r = vector_iinsert((char*)&(_x), sizeof(*(_x)), sizeof((_x)->Data[0]), (_i), (_s), (_e)); \
    _r;                                                                       \
})
#else
#define VECTOR_INSERT(_x, _i, _s, _e) (vector_iinsert((char*)&(_x), sizeof(*(_x)), sizeof((_x)->Data[0]), (_i), (_s), (_e)))
#endif
